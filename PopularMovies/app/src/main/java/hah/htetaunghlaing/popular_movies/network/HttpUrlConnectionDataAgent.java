package hah.htetaunghlaing.popular_movies.network;
...
import hah.htetaunghlaing.popular_movies.network.responses.GetNewsResponses;
            ...
            new AsyncTask<Void,Void,Void>(){
                ...
                protected Void doInBackground(Void... voids) {
                    ...
                    try {
                         ...
                         */
                        Gson gson= new Gson();
                        GetNewsResponses getNewsResponses =gson.fromJson(responseString, GetNewsResponses.class);
                        Log.d(PopularMoviesApp.Log_Tap,"getNewsResponses"+getNewsResponses);

                        EventBus.getDefault().post(new LoadMoviesEvent(getNewsResponses.getPopularMovies()));

                    } catch (Exception e) {

                        Log.e(PopularMoviesApp.Log_Tap,e.getMessage());
                    /*
